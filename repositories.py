from models import User, Outfit, Post, Favorite, Like, OutfitItem, Cloth, TryOn, Related
...
class TryOnRepository(BaseRepository):
    @staticmethod
    def get_by_users_id(user_id):
        return TryOn.query.filter_by(users_id=user_id).all()
